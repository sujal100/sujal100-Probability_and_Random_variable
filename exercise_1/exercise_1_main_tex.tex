...
\section{Solution}
Two event $E$ and $F$ are independent \\
if 
\begin{align*}
...
$$\mathrm{E}:(3,6)$$
$$\mathbf{Pr}(\mathbf{E})=\frac{2}{6}=\frac{1}{3}$$
$$\mathrm{F}:(2,4,6)$$
$$\mathbf{Pr}(\mathbf{F})=\frac{3}{6}=\frac{1}{2}$$
$E \cap F= $the number appearing is even multiple\\
of $3=(3)$\\
So, 
$$\mathbf{Pr}(\mathbf{E} \cap \mathbf{F})=\frac{1}{6}$$
Now,
$$\mathbf{Pr}(\mathbf{E}) \cdot \mathbf{Pr}(\mathbf{F})=\frac{1}{3} \cdot \frac{1}{2}=\frac{1}{6}$$
Since, 
$$\mathbf{Pr}(\mathbf{E} \cap \mathbf{F})=\mathbf{Pr}(\mathbf{E}) \cdot \mathbf{Pr}(\mathbf{F})$$
