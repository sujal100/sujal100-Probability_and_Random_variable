...
\multirow{2}{*}{No. of Ball after remove(if removed ball is white)} &
  ...
  \multirow{2}{*}{3} &
  $Pr(X_1=1,X_2=1)$ &
  Probability of  Second ball is White and First ball is White &
  $\frac{4}{7}\times\frac{3}{6}=\frac{2}{7}$ \\ \cline{4-6} 
 &
   &
   &
  $Pr(X_1=1,X_2=0)$ &
  Probability of Second ball is White and First ball is Red &
  $\frac{4}{7}\times\frac{3}{6}=\frac{2}{7}$ \\ \hline
\multirow{2}{*}{No. of Ball after remove(if removed ball is red)} &
  \multirow{2}{*}{2} &
  \multirow{2}{*}{4} &
  $Pr(X_1=0,X_2=1)$ &
  Probability of Second ball is Red and First ball is White &
  $\frac{3}{7}\times\frac{4}{6}=\frac{2}{7}$ \\ \cline{4-6} 
 &
   &
   &
  $Pr(X_1=0,X_2=0)$ &
  Probability of Second ball is Red and First ball is Red &
