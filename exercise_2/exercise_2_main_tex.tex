...
We have 6 balls, one ball can be choose in ${ }^{6} C_{1}$ ways, Since there are three red balls so probability that the second ball is red is
\begin{align}
P &=\frac{{ }^{6} C_{1}}{{ }^{3} C_{1}} \\
&=\frac{3}{6} \\
&=\frac{1}{2}
\end{align}
