...
Ball colour &
  ...
  Result \\ \hline
\multirow{2}{*}{No. of Ball before remove} &
  \multirow{2}{*}{3} &
  \multirow{2}{*}{4} &
  $Pr(X_1=1)$ &
  probability of First remove ball is White &
  $\frac{4}{7}$ \\ \cline{4-6} 
 &
   &
   &
  $Pr(X_1=0)$ &
  probability of First remove ball is Red &
  $\frac{3}{7}$ \\ \hline
\multirow{2}{*}{No. of Ball after remove(if removed ball is white)} &
  \multirow{2}{*}{3} &
  \multirow{2}{*}{3} &
  $Pr(X_1=1,X_2=1)$ &
  Probability of  First ball is White and Second ball is White &
  $\frac{4}{7}\times\frac{3}{6}=\frac{2}{7}$ \\ \cline{4-6} 
 &
   &
   &
  $Pr(X_1=1,X_2=0)$ &
  Probability of First ball is White and Second ball is Red &
  $\frac{4}{7}\times\frac{3}{6}=\frac{2}{7}$ \\ \hline
\multirow{2}{*}{No. of Ball after remove(if removed ball is red)} &
  \multirow{2}{*}{2} &
  \multirow{2}{*}{4} &
  $Pr(X_1=0,X_2=1)$ &
  Probability of First ball is Red and Second ball is White &
  $\frac{3}{7}\times\frac{4}{6}=\frac{2}{7}$ \\ \cline{4-6} 
 &
   &
   &
  $Pr(X_1=0,X_2=0)$ &
  Probability of First ball is Red and Second ball is Red &
  $\frac{3}{7}\times\frac{2}{6}=\frac{1}{7}$ \\ \hline
\end{tabular}%
}
