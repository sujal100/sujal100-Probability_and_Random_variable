...
(D) $\frac{200}{6^{5}}$
\section{Solution}
Let $P(n)$ be the probability that experiment ends in exactly $n$ rolls. Thus your problem is asking for $P(5).$ We note that
\begin{align}
P(1)=0, P(2)=\frac{1}{6^{2}}
\end{align} 
...
\begin{align}
P(n)=\frac{1}{6} \times \frac{5}{6} \times P(n-2)+\frac{5}{6} \times P(n-1)
\end{align}
So,
\begin{align}
P(3)=\frac{5}{6^{2}}P(1)+\frac{5}{6}P(2)=\frac{5}{6^{3}}\\
P(4)=\frac{5}{6^{2}}P(2)+\frac{5}{6}P(3)=\frac{30}{6^{4}}=\frac{5}{6^{3}}\\
P(5)=\frac{5}{6^{2}}P(3)+\frac{5}{6}P(4)=\frac{25+150}{6^{5}}=\frac{175}{6^{5}}
\end{align}
