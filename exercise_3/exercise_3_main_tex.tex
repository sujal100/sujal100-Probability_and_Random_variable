...
(D) $\frac{200}{6^{5}}$
\section{Solution}
Let Consider, Bernoulli random variables say $X$. Here, $P_x(n)$ refer to the probability that experiment ends in exactly $n^{th}$ rolls. Thus, problem is asking for $P_x(5).$ We note that
\begin{align}
P_x(1)=0, P_x(2)=\frac{1}{6^{2}}
\end{align} 
\begin{figure}
\centering
...
% Text Node
\draw (283,15.4) node [anchor=north west][inner sep=0.75pt]    {$Pr( X=n)$};
% Text Node
\draw (164,114.4) node [anchor=north west][inner sep=0.75pt]    {$5/6$};
% Text Node
\draw (341,115.4) node [anchor=north west][inner sep=0.75pt]    {$5/6$};
% Text Node
\draw (203,112.4) node [anchor=north west][inner sep=0.75pt]    {$\underbrace{Pr( X=n-2)}_{n-2}$};
% Text Node
\draw (385,113.4) node [anchor=north west][inner sep=0.75pt]    {$\underbrace{Pr( X=n-1)}_{n-1}$};
% Text Node
...
\begin{align}
P_x(n)=\frac{1}{6} \times \frac{5}{6} \times P_x(n-2)+\frac{5}{6} \times P_x(n-1)
\end{align}
So,
\begin{align}
&P_x(3)=\frac{5}{6^{2}}P_x(1)+\frac{5}{6}P_x(2)=\frac{5}{6^{3}}\\
&P_x(4)=\frac{5}{6^{2}}P_x(2)+\frac{5}{6}P_x(3)=\frac{30}{6^{4}}=\frac{5}{6^{3}}
\end{align}
therefore,
\begin{align}
P_x(5)=\frac{5}{6^{2}}P_x(3)+\frac{5}{6}P_x(4)=\frac{25+150}{6^{5}}=\frac{175}{6^{5}}
\end{align}
