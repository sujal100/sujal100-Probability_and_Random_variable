...
So, in almost surely,
\begin{align}
\left\{\dfrac{1}{2 n} \sum_{i=1}^{n} X_{2 i}-\dfrac{1}{2 n} \sum_{i=1}^{n} X_{2 i-1}\right\}&\rightarrow \left\{\dfrac{1}{2 n}nX-\dfrac{1}{2 n}nX\right\}\\
&=0
\end{align}
So, using $X_i \stackrel{a.s.}{\rightarrow} X$ this , we also conclude that
\begin{align}
\sup \left\{X_{1}, X_{2}, \ldots\right\}&=2 \,a.s.\\
\inf \left\{X_{1}, X_{2}, \ldots\right\}&=-1 \, a.s.
\end{align}
